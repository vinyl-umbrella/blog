...
[AWS Lambda の API リファレンス](https://docs.aws.amazon.com/ja_jp/lambda/latest/api/API_Operations.html) を見ると，アクションと次節で説明するパラメータの一覧を確認できます．
...
最後に，`HashedPayload` はリクエストボディの SHA-256 ハッシュ値を 16 進数で表現したものです．リクエストボディがないときは空文字列の SHA-256 ハッシュ値を使用します．
